...
- 파이썬 SQL Server 연동 프로그래밍
    - Madang DB 관리 프로그램
        ...
        - DB연결 설정 - Oracle, MySQL 등은 설정이 없음. 구성관리자에서 TCP/IP로 접근을 허용하지 않으면 접속 안됨
            ...
            ![구성관리자](https://raw.githubusercontent.com/HeoYongmin/basic-database-2024/main/images/db005.png)
...
- 파이썬 SQL Server 연동 프로그래밍
    ...
    - 문제점 - 한글 깨짐문제
        ...
        - 실행화면
          ...
          https://github.com/HeoYongmin/basic-database-2024/assets/158007383/d50dc117-c3a8-4500-8de2-8af16835281e
...
- 인덱스 예제
    ...
    <!-- md 주석. ![인덱스](https://raw.githubusercontent.com/HeoYongmin/basic-database-2024/main/images/db006.png) -->
    <!-- html img태그가 이미지 사이즈 조정 가능 -->
    <img src="https://raw.githubusercontent.com/HeoYongmin/basic-database-2024/main/images/db006.png" width="900">
...
- 정규화
    ...
    - BCNF정규형 - 함수 종속성 X -> Y가 성립할때 모든 결정자X가 후보키이면(기본키가 될 수 있는 속성)이면
    - 보통 BCNF까지 정규화를 함
...
- 실무실습
    - 쿼리실습
        ...
        - 집계함수 GROPP BY, ROLLUP
        - JOIN, SUBQUERY, UNION ...
        - CASE WHEN THEN END...
        - 내장함수 ...

    ![HR_ERD](https://raw.githubusercontent.com/HeoYongmin/basic-database-2024/main/images/db007.png)
