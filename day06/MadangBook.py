...
userPass = 'mssql_p@ss'
dbName = 'Madang'
dbCharset = 'UTF-8' # EUC-KR 사용하면 안됨
...
class qtApp(QMainWindow):
    ...
    def initUI(self) -> None:
        ...
        self.btnReload_clicked() # 조회버튼 클릭 함수만 실행하면
    ...
    def btnSave_clicked(self): # 저장버튼 클릭
        ...
        if mode =='I': # INSERT 경우
            ...
            query = f'''SELECT COUNT(*)
                     FROM Book
                    WHERE bookid = {self.txtBookid.text()}''' # 현재 입력하고자하는 번호가 있는 확인 쿼리
    ...
    def btnDel_clicked(self): # 삭제버튼 클릭
        ...
        self.btnReload_clicked() # 삭제 후에도 재조회 해야 함
